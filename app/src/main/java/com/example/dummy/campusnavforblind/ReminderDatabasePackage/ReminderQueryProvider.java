...
public class ReminderQueryProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(ReminderDbConfig.CONTENT_AUTHORITY, ReminderDbConfig.PATH_VEHICLE, REMINDER);

        sUriMatcher.addURI(ReminderDbConfig.CONTENT_AUTHORITY, ReminderDbConfig.PATH_VEHICLE + "/#", REMINDER_ID);
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (match) {
            case REMINDER:
                return ReminderDbConfig.ReminderEntry.CONTENT_LIST_TYPE;
            case REMINDER_ID:
                return ReminderDbConfig.ReminderEntry.CONTENT_ITEM_TYPE;
            default:
    ...
    private Uri insertReminder(Uri uri, ContentValues values) {
        ...
        long id = database.insert(ReminderDbConfig.ReminderEntry.TABLE_NAME, null, values);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case REMINDER:
                rowsDeleted = database.delete(ReminderDbConfig.ReminderEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case REMINDER_ID:
                selection = ReminderDbConfig.ReminderEntry._ID + "=?";
                selectionArgs = new String[] { String.valueOf(ContentUris.parseId(uri)) };
    ...
    private int updateReminder(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(ReminderDbConfig.ReminderEntry.TABLE_NAME, values, selection, selectionArgs);
